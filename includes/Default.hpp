...
const char *const	DEFAULT_LOG_FILE	= "./webserv.log"; ///< Chemin vers le fichier log ou COUT et CERR sont rediriger
...
const time_t		CGI_TIMEOUT			= 30;			///< duree dattente max dun enfant dans le cgi apes un fork
